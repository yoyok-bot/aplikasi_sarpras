<div class="modal fade" id="editguru">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('guru.update')}}" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                @method('PUT')
    ...
    @push('script')
    <script>
$('body').on("click", '.editguru', function (e) {
            $('#editguru').modal("show");
            $.get("guru/edit/" + $(this).attr('data'), function (data) {
                console.log(data);
                $('#idadmin').val(data.id);
