...
<li class="nav-item d-none d-sm-inline-block">
  ...
  <li class="nav-item d-none d-sm-inline-block">
    <a href="#" class="nav-link">Kepala Sekolah</a>
  </li>
@endsection
                      ...
                      <tr>
                        ...
                        <td>{{ $item->nama }}</td>
                          ...
                          <td class="text-center">
                            <a href="#" data-toggle="modal" data="{{$item->id}}" class="btn btn-success editkepsek" data-target="#editkepsek" style="font-size: 15px"><i class="fa fa-edit"></i></a>
                            <a href="#" data-id="{{$item->id_user}}" class="btn btn-danger hapus-data" style="font-size: 15px"><i class="fa fa-trash"></i></a>
                            <a href="{{ route('kepsek.reset', $item->id_user)}}" class="btn btn-warning">
                                <i class="fa fa-refresh"></i>
                              </a>
                            @if($item->user->status == 'Aktif')
                            <a href="{{ route('kepsek.status', $item->id_user)}}" class="btn btn-danger">
                              <i class="fa fa-ban"></i>
                            </a>
                            @else
                            <a href="{{ route('kepsek.status', $item->id_user)}}" class="btn btn-success">
...
<script>
    var del = function (id) {
        ...
        $('#list').change(function () {
            document.location.href = '{{url('kepsek')}}/?id=' + $('#list').val();
            });
                });
</script>
@endpush
