<div class="modal fade" id="editkepsek">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('kepsek.update')}}" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label for="nama">NIP</label>
                    <input type="hidden" id="idadmin" name="id" class="form-control" required>
    ...
    @push('script')
    <script>
$('body').on("click", '.editkepsek', function (e) {
            $('#editkepsek').modal("show");
            $.get("kepsek/edit/" + $(this).attr('data'), function (data) {
                console.log(data);
                $('#idadmin').val(data.id);
