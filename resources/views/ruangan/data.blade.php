        ...
        <div class="card">
            <div class="card-body">
                <div class="general-button">
                    ...
                    @endif
                          <div class="float-right">
                            <form class="form-inline my-2 my-lg-0" type="get" action="{{url('/ruangan')}}">
                    ...
                    @endphp
                      ...
                      <tr>
                        <td class="text-center">{{ $nomor++ }}</td>
                          <td>{{ $item->nama_ruangan }} {{ now()}}</td>
                          <td class="text-center">
                            <a href="#" data-toggle="modal" data="{{$item->id}}" class="btn btn-success editdata" data-target="#editruangan" style="font-size: 15px"><i class="fa fa-edit"></i></a>
                            <a href="#" data-id="{{$item->id}}" class="btn btn-danger hapus-data" style="font-size: 15px"><i class="fa fa-trash"></i></a>
                          </td>
                      </tr>
                      @endforeach
                      @else
...
<script>
    var del = function (id) {
        ...
        $('#list').change(function () {
            document.location.href = '{{url('ruangan')}}/?id=' + $('#list').val();
            });
                });
</script>
@endpush
