        ...
        <div class="card">
            <div class="card-body">
                <div class="general-button">
                    ...
                    @endif
                          <div class="float-right">
                            <form class="form-inline my-2 my-lg-0" type="get" action="{{url('/siswa')}}">
                      ...
                      <tr>
                        ...
                        <td>{{ $item->nisn }}</td>
                          ...
                          <td class="text-center">
                            <a href="#" data-toggle="modal" data="{{$item->id}}" class="btn btn-success editsiswa" data-target="#editsiswa" style="font-size: 15px"><i class="fa fa-edit"></i></a>
                            <a href="#" data-id="{{$item->id_user}}" class="btn btn-danger hapus-data" style="font-size: 15px"><i class="fa fa-trash"></i></a>
                            <a href="{{ route('siswa.reset', $item->id_user)}}" class="btn btn-warning">
                                <i class="fa fa-refresh"></i>
                              </a>
                            @if($item->user->status == 'Aktif')
                            <a href="{{ route('siswa.status', $item->id_user)}}" class="btn btn-danger">
                              <i class="fa fa-ban"></i>
                            </a>
                            @else
                            <a href="{{ route('siswa.status', $item->id_user)}}" class="btn btn-success">
...
<script>
    var del = function (id) {
        ...
        $('#list').change(function () {
            document.location.href = '{{url('siswa')}}/?id=' + $('#list').val();
            });
                });
</script>
@endpush
